  ...
  await sendEmail({
    ...
    html: `
      <div style="font-family:Georgia,serif;max-width:480px;margin:0 auto;padding:36px;
        ...
        <h2 style="color:#2c1810;text-align:center;">Leonine Villa Natura Resort</h2>
        ...
        <p style="color:#2c1810;line-height:1.6;">
          Please enter the verification code below to confirm your identity:
        </p>
        <div style="text-align:center;margin:28px 0;">
          <div style="display:inline-block;background:#2c1810;color:#f4e4c1;
                      ...
                      padding:20px 44px;border-radius:4px;font-family:monospace;">
            ${otp}
          </div>
        </div>
        <p style="color:#5a3e2b;font-size:0.85rem;text-align:center;">
        ...
        <p style="color:#8b6030;font-size:0.7rem;text-align:center;margin:0;">
          Leonine Villa Natura Resort &middot; Kandy, Sri Lanka
        </p>
      </div>
    `,
  });
  ...
  await sendEmail({
    ...
    html: `
      <div style="font-family:Georgia,serif;max-width:540px;margin:0 auto;padding:40px;
                  background:#f7e8c8;border:1px solid #d4b888;border-radius:4px;">
        <h2 style="color:#2c1810;text-align:center;">Leonine Villa Natura Resort</h2>
        <p style="color:#8b6030;font-style:italic;font-size:0.82rem;text-align:center;">Kandy, Sri Lanka</p>
        <hr style="border:none;border-top:1px solid #b8860b;margin:16px 0;" />
        <p style="color:#5a3e2b;font-style:italic;">Dear Esteemed Guest,</p>
        <p style="color:#2c1810;line-height:1.75;">
          We are delighted to confirm your reservation has been received at the estate.
        </p>
        <table style="width:100%;border-collapse:collapse;margin-bottom:24px;font-size:0.9rem;">
          <tr style="background:#e8d090;">
            <td colspan="2" style="padding:10px 16px;color:#2c1810;font-weight:bold;font-size:0.75rem;letter-spacing:0.14em;text-transform:uppercase;">
              Reservation Details
            </td>
          </tr>
          <tr style="border-bottom:1px solid #d4b88844;">
            <td style="padding:10px 16px;color:#8b6030;font-style:italic;width:42%;">Booking Reference</td>
        ...
        <div style="background:#f0e4c0;border-left:3px solid #b8860b;padding:14px 18px;margin-bottom:24px;">
...
export async function resendOtp(req, res) {
  try {
    ...
    const otp = Math.floor(1000 + Math.random() * 9000);
    await new Otp({ email, otp }).save();
    console.log(`OTP resaved for ${email}: ${otp}`);
